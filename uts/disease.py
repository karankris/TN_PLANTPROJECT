disease_dic = {
    'Sunflower___scab': """ <b>Crop</b>: Sunflower <br/>Disease: Sunflower Scab<br/>
        <br/> Cause of disease:

        <br/><br/> 1. Sunflower___scab overwinters primarily in fallen leaves and in the soil. Disease development is favored by wet, cool weather that generally occurs in spring and early summer.

        <br/> 2. Fungal spores are carried by wind, rain or splashing water from the ground to flowers, leaves or fruit. During damp or rainy periods, newly opening sunflower leaves are extremely susceptible to infection. The longer the leaves remain wet, the more severe the infection will be. scab spreads rapidly between 55-75 degrees Fahrenheit.
    ...
    'Groundnut___peanut mottle': """ <b>Crop</b>: Groundnut <br/>Disease:peanut mottle<br/>
        <br/> Cause of disease:

        <br/><br/>Black rot is caused by the fungus Diplodia seriata (syn Botryosphaeria obtusa).The fungus can infect dead tissue as well as living trunks, branches, leaves and seeds. In wet weather, spores are released from these infections and spread by wind or splashing water. The fungus infects leaves and seeds through natural openings or minor wounds.
        <br/><br/> How to prevent/cure the disease <br/>
        ...
        <br/>5. Be sure to remove the stumps of any peanut plamt you cut down. Dead stumps can be a source of spores.""",

    'Rapeseed___Cedar_rust': """ <b>Crop</b>: Apple <br/>Disease: Cedar Rapeseed Rust<br/>
        <br/> Cause of disease:

        <br/><br/>Cedar Rapeseed rust (Gymnosporangium juniperi-virginianae) is a fungal disease that depends on two species to spread and develop. It spends a portion of its two-year life cycle on Eastern red cedar (Juniperus virginiana). The pathogen’s spores develop in late fall on the juniper as a reddish brown gall on young branches of the trees.

        <br/><br/> How to prevent/cure the disease <br/>
        <br/>1. Since the juniper galls are the source of the spores that infect the stem, cutting them is a sound strategy if there aren’t too many of them.
    ...
    'Palm(including_sour)___Powdery_mildew': """ <b>Crop</b>: Palm <br/>Disease: Powdery Mildew<br/>
        <br/> Cause of disease:
    ...
    'Palm___Cercospora_leaf_spot Gray_leaf_spot': """ <b>Crop</b>:Palm <br/>Disease: Grey Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    'Palm___Common_rust_': """ <b>Crop</b>:Palm <br/>Disease: Common Rust<br/>
        <br/> Cause of disease:
    ...
    'Indian Mustared___Northern_Leaf_Blight': """ <b>Crop</b>: Indian Mustared <br/>Disease: Northern Leaf Blight
        <br/>
        <br/> Cause of disease:
    ...
    'Coconut___Black_rot': """ <b>Crop</b>: Coconut <br/>Disease: Black Rot<br/>
        <br/> Cause of disease:
    ...
    'Coconut_(Black_Measles)': """ <b>Crop</b>:Coconut<br/>Disease: Black Measles<br/>
        <br/> Cause of disease:
